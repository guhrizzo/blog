...
export default function GerenciarProdutos() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans pb-20">
            ...
            {/* Header do Admin */}
            <nav className="bg-white border-b border-slate-200 p-6 mb-8">
                <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
                    <div>
                        <Link href="/admin" className="text-sm font-bold text-slate-400 hover:text-blue-600 transition-colors">
                            ← Voltar ao Painel
                        </Link>
                        <h1 className="text-2xl font-black text-slate-900 mt-1">Gerenciar <span className="text-blue-500">Produtos</span></h1>
                    </div>
                    <Link
            ...
            <main className="max-w-6xl mx-auto px-6">
                {carregando ? (
                    ...
                    <div className="bg-white rounded-3xl p-20 text-center border border-slate-200">
                        ...
                        <p className="text-slate-500 font-medium text-lg">Nenhum produto cadastrado no catálogo.</p>
                    </div>
                ) : (
